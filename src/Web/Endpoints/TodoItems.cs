using Fides.Application.Common.Models;
using Fides.Application.TodoItems.Commands.CreateTodoItem;
using Fides.Application.TodoItems.Commands.DeleteTodoItem;
using Fides.Application.TodoItems.Commands.UpdateTodoItem;
using Fides.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Fides.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace Fides.Web.Endpoints;
